...
Sophus::SE3f System::TrackMonocular(const cv::Mat &im, const double &timestamp, Sophus::SE3f *gt_pose, const vector<IMU::Point>& vImuMeas, string filename)
{
    ...
    Sophus::SE3f Tcw = mpTracker->GrabImageMonocular(imToFeed,timestamp,filename, gt_pose);
